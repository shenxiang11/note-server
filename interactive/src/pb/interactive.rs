...
pub struct IncreaseCountRequest {
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct IncreaseCountResponse {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct DecreaseCountRequest {
    #[prost(enumeration = "CountBiz", tag = "1")]
    pub biz: i32,
    #[prost(int64, tag = "2")]
    pub biz_id: i64,
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct DecreaseCountResponse {}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod interactive_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn increase_count(
            &mut self,
            request: impl tonic::IntoRequest<super::IncreaseCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::IncreaseCountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/interactive.InteractiveService/IncreaseCount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("interactive.InteractiveService", "IncreaseCount"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn decrease_count(
            &mut self,
            request: impl tonic::IntoRequest<super::DecreaseCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DecreaseCountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/interactive.InteractiveService/DecreaseCount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("interactive.InteractiveService", "DecreaseCount"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod interactive_service_server {
    ...
    pub trait InteractiveService: std::marker::Send + std::marker::Sync + 'static {
        async fn increase_count(
            &self,
            request: tonic::Request<super::IncreaseCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::IncreaseCountResponse>,
            tonic::Status,
        >;
        async fn decrease_count(
            &self,
            request: tonic::Request<super::DecreaseCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DecreaseCountResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/interactive.InteractiveService/IncreaseCount" => {
                    ...
                    struct IncreaseCountSvc<T: InteractiveService>(pub Arc<T>);
                    impl<
                        T: InteractiveService,
                    > tonic::server::UnaryService<super::IncreaseCountRequest>
                    for IncreaseCountSvc<T> {
                        type Response = super::IncreaseCountResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as InteractiveService>::increase_count(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/interactive.InteractiveService/DecreaseCount" => {
                    #[allow(non_camel_case_types)]
                    struct DecreaseCountSvc<T: InteractiveService>(pub Arc<T>);
                    impl<
                        T: InteractiveService,
                    > tonic::server::UnaryService<super::DecreaseCountRequest>
                    for DecreaseCountSvc<T> {
                        type Response = super::DecreaseCountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InteractiveService>::decrease_count(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DecreaseCountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
