...
pub struct BatchGetIsFollowedRequest {
    #[prost(message, repeated, tag = "1")]
    pub query: ::prost::alloc::vec::Vec<IsFollowedQuery>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BatchGetIsFollowedResponse {
    #[prost(message, repeated, tag = "1")]
    pub result: ::prost::alloc::vec::Vec<IsFollowedResponse>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetFollowsCountRequest {
    #[prost(int64, tag = "1")]
    pub user_id: i64,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetFollowsCountResponse {
    #[prost(int64, tag = "1")]
    pub count: i64,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetFansCountRequest {
    #[prost(int64, tag = "1")]
    pub user_id: i64,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct GetFansCountResponse {
    #[prost(int64, tag = "1")]
    pub count: i64,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct UpdateUserRequest {
    ...
    pub fullname: ::core::option::Option<::prost::alloc::string::String>,
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn send_register_email_code(
            &mut self,
            request: impl tonic::IntoRequest<super::SendRegisterEmailCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendRegisterEmailCodeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/SendRegisterEmailCode",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "SendRegisterEmailCode"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "FollowUser"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn unfollow_user(
            &mut self,
            request: impl tonic::IntoRequest<super::UnfollowUserRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnfollowUserResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "UnfollowUser"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_follows_count(
            &mut self,
            request: impl tonic::IntoRequest<super::GetFollowsCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetFollowsCountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/GetFollowsCount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "GetFollowsCount"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_fans_count(
            &mut self,
            request: impl tonic::IntoRequest<super::GetFansCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetFansCountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/GetFansCount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "GetFansCount"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn batch_get_is_followed(
            &mut self,
            request: impl tonic::IntoRequest<super::BatchGetIsFollowedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchGetIsFollowedResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/BatchGetIsFollowed",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "BatchGetIsFollowed"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod user_service_server {
    ...
    pub trait UserService: std::marker::Send + std::marker::Sync + 'static {
        async fn send_register_email_code(
            &self,
            request: tonic::Request<super::SendRegisterEmailCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendRegisterEmailCodeResponse>,
            tonic::Status,
        >;
        ...
        async fn unfollow_user(
            &self,
            request: tonic::Request<super::UnfollowUserRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UnfollowUserResponse>,
            tonic::Status,
        >;
        async fn get_follows_count(
            &self,
            request: tonic::Request<super::GetFollowsCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetFollowsCountResponse>,
            tonic::Status,
        >;
        async fn get_fans_count(
            &self,
            request: tonic::Request<super::GetFansCountRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetFansCountResponse>,
            tonic::Status,
        >;
        async fn batch_get_is_followed(
            &self,
            request: tonic::Request<super::BatchGetIsFollowedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::BatchGetIsFollowedResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/user.UserService/SendRegisterEmailCode" => {
                    ...
                    struct SendRegisterEmailCodeSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::SendRegisterEmailCodeRequest>
                    for SendRegisterEmailCodeSvc<T> {
                        type Response = super::SendRegisterEmailCodeResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UserService>::send_register_email_code(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = SendRegisterEmailCodeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/user.UserService/UnfollowUser" => {
                    ...
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::UnfollowUserRequest>
                    for UnfollowUserSvc<T> {
                        type Response = super::UnfollowUserResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/user.UserService/GetFollowsCount" => {
                    #[allow(non_camel_case_types)]
                    struct GetFollowsCountSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::GetFollowsCountRequest>
                    for GetFollowsCountSvc<T> {
                        type Response = super::GetFollowsCountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::get_follows_count(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetFollowsCountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/user.UserService/GetFansCount" => {
                    #[allow(non_camel_case_types)]
                    struct GetFansCountSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::GetFansCountRequest>
                    for GetFansCountSvc<T> {
                        type Response = super::GetFansCountResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::get_fans_count(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetFansCountSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/user.UserService/BatchGetIsFollowed" => {
                    #[allow(non_camel_case_types)]
                    struct BatchGetIsFollowedSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::BatchGetIsFollowedRequest>
                    for BatchGetIsFollowedSvc<T> {
                        type Response = super::BatchGetIsFollowedResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::batch_get_is_followed(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = BatchGetIsFollowedSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
