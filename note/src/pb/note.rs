...
pub struct PublishDraftNoteRequest {
    #[prost(int64, tag = "1")]
    pub id: i64,
    #[prost(int64, tag = "2")]
    pub user_id: i64,
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct PublishDraftNoteResponse {}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CreateOrUpdateDraftRequest {
    #[prost(int64, tag = "1")]
    pub user_id: i64,
    #[prost(int64, optional, tag = "2")]
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct CreateOrUpdateDraftResponse {
    #[prost(int64, tag = "1")]
    pub id: i64,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod note_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_or_update_draft_note(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateOrUpdateDraftRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOrUpdateDraftResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/note.NoteService/CreateOrUpdateDraftNote",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("note.NoteService", "CreateOrUpdateDraftNote"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn publish_draft_note(
            &mut self,
            request: impl tonic::IntoRequest<super::PublishDraftNoteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PublishDraftNoteResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/note.NoteService/PublishDraftNote",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("note.NoteService", "PublishDraftNote"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod note_service_server {
    ...
    pub trait NoteService: std::marker::Send + std::marker::Sync + 'static {
        async fn create_or_update_draft_note(
            &self,
            request: tonic::Request<super::CreateOrUpdateDraftRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateOrUpdateDraftResponse>,
            tonic::Status,
        >;
        async fn publish_draft_note(
            &self,
            request: tonic::Request<super::PublishDraftNoteRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PublishDraftNoteResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/note.NoteService/CreateOrUpdateDraftNote" => {
                    ...
                    struct CreateOrUpdateDraftNoteSvc<T: NoteService>(pub Arc<T>);
                    impl<
                        T: NoteService,
                    > tonic::server::UnaryService<super::CreateOrUpdateDraftRequest>
                    for CreateOrUpdateDraftNoteSvc<T> {
                        type Response = super::CreateOrUpdateDraftResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as NoteService>::create_or_update_draft_note(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let fut = async move {
                        let method = CreateOrUpdateDraftNoteSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/note.NoteService/PublishDraftNote" => {
                    #[allow(non_camel_case_types)]
                    struct PublishDraftNoteSvc<T: NoteService>(pub Arc<T>);
                    impl<
                        T: NoteService,
                    > tonic::server::UnaryService<super::PublishDraftNoteRequest>
                    for PublishDraftNoteSvc<T> {
                        type Response = super::PublishDraftNoteResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NoteService>::publish_draft_note(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PublishDraftNoteSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
