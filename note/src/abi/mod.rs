...
use crate::pb::note::{
    ...
    GetPublishedNoteRequest, GetPublishedNoteResponse, GetPublishedNotesRequest,
    GetPublishedNotesResponse, GetUserPublishedNoteIdsRequest, GetUserPublishedNoteIdsResponse,
    GetUserPublishedNotesRequest, GetUserPublishedNotesResponse, ImageList, NormalNote, VideoNote,
};
use crate::NoteSrv;
