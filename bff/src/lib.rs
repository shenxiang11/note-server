...
pub async fn start_server(
    ...
    .data(DataLoader::new(
        NoteCommentsCountLoader::new(app_state.interactive_srv.clone()),
        tokio::spawn,
    ))
    .data(DataLoader::new(
    ...
    .data(DataLoader::new(
        NoteLikesCountLoader::new(app_state.interactive_srv.clone()),
        tokio::spawn,
    ))
    .data(DataLoader::new(
        NoteCollectedCountLoader::new(app_state.interactive_srv.clone()),
        tokio::spawn,
    ))
    .data(DataLoader::new(
        UserFollowedLoader::new(app_state.user_srv.clone()),
        tokio::spawn,
    ))
    .data(DataLoader::new(
        NoteCollectedLoader::new(app_state.interactive_srv.clone()),
        tokio::spawn,
    ))
    .data(DataLoader::new(
